...
<!-- [00.0 - Top](#Seanpm2001](https://github.com/seanpm2001)-GitHub-Profile-Navigation-Gist) !--><!-- Removed for technical reasons !-->
...
<!-- 17 added on December 25th 2020 !-->
...
<!--
V5 notes
As of December 4th 2020, V5 is considered one of the biggest updates to the project since its inception
!-->

<!--
V6 notes
Plans for V1.5/V6 of the Gist search tool

Stars in the links of top languages, along with a note of following the stars
Filter search (GitHub stars) make sure to accurately denote that nearly 25% (would be nearly 50% if not counting forks) of the starred projects (as of December 3rd 2020) are NOT yours
...
Link to followers
V6 surpassed V5 in terms of features, length, and functionality.
!-->
...
Version 2 (Sunday, November 29th 2020 at 4:26 pm)
...
> * Commented out the version history section

> * Added support for searching by project

> * Added support for searching within the SNU project

> * Added support for searching within the Seanpm2001-lifearchive project

> * Added support for searching within the Meadows project

> * No other changes in version 2

Version 3 (Tuesday, December 1st 2020 at 8:36 pm)

> Changes:

> * Added support for SNU Programming Tool modules

> * Added support for 9 new languages (yacc, clojure, lisp flavored erlang (lfe), julia, m4, objective-j, postscript, systemverilog, and verilog)
...
Version 4 (Wednesday, December 2nd 2020 at 7:02 pm)

> Changes:

> * Added support for Q# (Q Sharp, Quantum computer programming language by {::} Microsoft)

> * Added support for several Meadows flags, as I have recently resumed Meadows development (currently in the `git-conversion` process)
...
Version 5 (Thursday, December 3rd 2020 at 8:35 pm)

> Changes:

> * Added support for the seanwallawalla flag

> * Moved notes from the last build out of the output body and commented them out (they will now not display when viewing the Gist, only in the source)
...
> * Added in several entries where there are no more results

> * Added in 27 output section markers for searching by language only

> * No other changes in version 5

Version 6 (Friday, December 4th 2020 at 8:02 pm)
...
> * Added in a known bugs section

> * Updated the index

> * Starred programming language searches for languages I know best

> * Added support for follower search

> * Added support for star search

> * Added support for topic search

> * Added support for sorting through 20 different GitHub organizations

> * Added new comments

> * No other changes in version 6

Version 7 (Sunday, December 6th 2020 at 9:23 pm)

> Changes:

> * Updated the languages list, adding notes for languages I know well/know best, and adding support for AWK and Limbo searches
...
Version 8 (Monday, December 7th 2020 at 7:15 pm)

> Changes:

> * Updated the languages list, adding support for R, Raku, and Rebol (tomorrow: REBOL (December 8th 2020)) # Actually: December 7th 2020, same day. I ended up doing it early
...
Version 9 (Wednesday, December 9th 2020 at 2:33 pm)

> Changes:

> * Updated the language list, removing a REBOL comment, adding a REBOL comment, and adding support for Jupyters notebook
...
Version 10 (Thursday, December 10th 2020 at 8:24 pm)

> Changes:

> * Updated the language list, adding support for Assembly, Kotlin, and Inno Setup
...
Version 11 (Saturday, December 19th 2020 at 9:25 pm)

> Changes:

> * Updated the language list, adding support for the Hack programming language
...
Version 12 (Sunday, December 20th 2020 at 8:03 pm)

> Changes:

> * Updated the language list, adding support for Vue and Handlebars

> * Added a section for repositories that pass through the given search filters
...
Version 13 (Friday, December 25th 2020 at 7:23 pm)

> Changes:

> * Updated the language list, adding support for C#, D, and Stylus

> * Updated the section for repositories that pass through the given search filters, adding 17 more projects that pass through the given filters
...
Version 14 (Saturday, December 26th 2020 at 7:41 pm)

> Changes:

> * Updated the language list, adding support for Less, SCSS, and SASS
...
Version 18 (Tuesday, January 12th 2021 at 6:22 pm)

> Changes:

> * Finally removed a syntax error where the comment becomes unclosed on the version 14 entry, causing the rest of version 14s entry along with the rest of the version history to display in the document. I have been procrastinating on this, and along with that keep forgetting to fix this bug, until now
...
Version 19 (Thursday, January 21st 2021 at 7:31 pm)

> Changes:

> * Updated the language list, added support for Crystal and Lua. If GitHub ever recognizes the cuda code I put in a repository, I will add that to this file.
